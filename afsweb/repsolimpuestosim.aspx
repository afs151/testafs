<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repsolimpuestosim.aspx.cs" Inherits="afsweb.repsolimpuestosim" %>
...
<body class="menubar-hoverable header-fixed ">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <i class="fa fa-lightbulb-o"></i><strong> Informacion:</strong> Este reporte le va a mostrar <strong> los impuestos </strong> que esten dentro del rango de fechas proporcionado (fecha de pago pedimento) y de las Aduanas asignadas a su perfil. 
    ...
    <script src="assets/js/core/demo/repsolimpuestosim.js"></script>
    <!-- END JAVASCRIPT -->
