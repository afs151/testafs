<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repanexo19N.aspx.cs" Inherits="afsweb.repanexo19N" %>
<!-- Ulñtima version -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="menubar-hoverable header-fixed ">
        ...
        <div id="content">
            <section class="style-default-bright">
                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Reporte General de pedimentos</h4>
                        </div>
                        <!--end .col -->
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <i class="fa fa-lightbulb-o"></i><strong> Informacion:</strong> Este reporte le va a mostrar el <strong> detalle de los pedimentos según el Anexo 19 </strong>que estén dentro del rango proporcionado (fecha de pago) con excepción del presente día y de las Aduanas asignadas a su perfil.
                                    <br> <i class="fa fa-exclamation-triangle"></i><strong> Atención:</strong> Detalle generado a partir de diferentes datos del Pedimento (Aduanet).
                                </div>
                            </div>
    ...
    <script src="assets/js/core/demo/repanexo19N.js"></script>
    <!-- END JAVASCRIPT -->
