<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reprojosr1.aspx.cs" Inherits="afsweb.reprojosr1" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title><%=ConfigurationManager.AppSettings["CIA.NAME"]%>s - Reportes</title>
...
<body class="menubar-hoverable header-fixed ">
        ...
        <div id="content">
            <section class="style-default-bright">
                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Reporte de rojos y rectificaciones</h4>
                        </div>
                        <!--end .col -->
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <i class="fa fa-lightbulb-o"></i><strong> Informacion:</strong> Este reporte le va a mostrar <strong> Rojos obtenidos </strong> que esten dentro del rango de fechas proporcionado (fecha de pago pedimento) y de las Aduanas asignadas a su perfil. 
                                    <br> <i class="fa fa-exclamation-triangle"></i><strong> Atención:</strong> Detalle de los datos generales y las contribuciones de Pedimento (Aduanet).
                                </div>
                            </div>
    ...
    <script src="assets/js/core/demo/reprojosr1.js"></script>
    <!-- END JAVASCRIPT -->
