<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repprogramacion.aspx.cs" Inherits="afsweb.repprogramacion" %>
...
<body class="menubar-hoverable header-fixed ">
        ...
        <div id="content">
            <section class="style-default-bright">
                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Reporte de programacion de cruces</h4>
                        </div>
                        <!--end .col -->
                    </div>
                    <div class="row">
    ...
    <script src="assets/js/core/demo/repprogramacion.js"></script>
    <!-- END JAVASCRIPT -->
