<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reppedpagdes.aspx.cs" Inherits="afsweb.reppedpagdes" %>
...
<body class="menubar-hoverable header-fixed ">
        ...
        <div id="content">
            <section class="style-default-bright">
                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Reporte de pedimentos pagados/desaduanados Aduana Laredo/Colombia</h4>
                        </div>
                        <!--end .col -->
                    </div>
                    <div class="row">
    ...
    <script src="assets/js/core/demo/reppedpagdes.js"></script>
    <!-- END JAVASCRIPT -->
