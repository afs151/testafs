<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reppedimentos.aspx.cs" Inherits="afsweb.reppedimentos" %>
...
<body class="menubar-hoverable header-fixed ">
        ...
        <div id="content">
            <section class="style-default-bright">
                <div class="section-header">
                    <ol class="breadcrumb">
                        <li>Reportes</li>
                        <li class="active">Pedimentos Pagados</li>
                    </ol>
                </div>
                <div class="section-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Reporte pedimentos pagados</h4>
                        </div>
                        <!--end .col -->
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="alert alert-warning" role="alert">
                                    <i class="fa fa-lightbulb-o"></i><strong> Informacion:</strong> Este reporte le va a mostrar el <strong> detalle de Pedimentos </strong> que esten dentro del rango de fechas proporcionado (fecha de pago pedimento), del tipo de operacion proporcionado y de las Aduanas asignadas a su perfil. 
    ...
    <script src="assets/js/core/demo/reppedimentos.js"></script>
    <!-- END JAVASCRIPT -->
