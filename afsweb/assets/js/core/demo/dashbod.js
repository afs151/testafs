    ...
    p._createdomgrid = function (ctrlgrid, btnprogtraf, btnexporta, ctrlmenu) {
        ...
        $(ctrlgrid).jqxGrid(
        {
            ...
            columns: [
                ...
                { text: 'REMISION', datafield: 'iconsecutivoordencarga', cellclassname: cellclassstatusrem, width: 100 },
                {
                    text: 'INICIO CARGA', columntype: 'button', datafield: 'tpfechainicarga', cellclassname: cellclass, width: 150,
                ...
                {
                    text: 'FINALIZA CARGA', columntype: 'button', datafield: 'tpfechafincarga', cellclassname: cellclass, width: 150,
                    buttonclick: function (row, column, columntype, oldvalue, newvalue) {
                        var value = $(ctrlgrid).jqxGrid('getcellvalue', row, 'tpreferencia');
                        var dateini = $(ctrlgrid).jqxGrid('getcellvalue', row, 'tpfechainicarga');
                        var datefin = $(ctrlgrid).jqxGrid('getcellvalue', row, 'tpfechafincarga');
                ...
                { text: 'ESTATUS BODEGA', datafield: 'tpstatusbodid', cellclassname: cellclassstatusrem },
