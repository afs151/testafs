(function (namespace, $) {
    ...
    p._createdomgrid = function (ctrlgrid, btnprogtraf, btnexporta, ctrlmenu) {
        ...
        $(ctrlgrid).jqxGrid(
        {
            ...
            columns: [
                ...
                { text: 'TP', datafield: 'scvedocumento', cellclassname: cellclass, width: 25 },
    ...
    p._refreshgridprogramacion = function () {
        ...
        var url = 'services/dashboard.asmx/loadgridprogramacionfullexpo';
        $.ajax({
            type: 'POST',
            url: url,
            data: JSON.stringify({}),
            ...
            success: function (result) {
                var datanew = $.parseJSON(result.d).Table1;
                var source =
                        {
                            localdata: datanew,
                            datatype: "json",
                ...
                $('#jqxgridexp').jqxGrid({ source: dataAdapter });
                var datainformations = $('#jqxgridexp').jqxGrid('getdatainformation');
                var rowscounts = datainformations.rowscount;

                $("#currentTime").text("Total de exportaciones programadas para el dia de hoy: " + rowscounts);
    ...
    p._loadMorrisCruces = function (obj) {
        Morris.Area({
            ...
            xkey: 'y',
            ykeys: ['c', 'a', 'b'],
            labels: ['Remesas', 'exportacion', 'Exportacion']
        });
    }
    ...
    // =========================================================================
    namespace.dashexpo = new dashexpo;
